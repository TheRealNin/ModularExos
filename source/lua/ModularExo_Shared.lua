...
Script.Load("lua/ModularExo_MarineTeam.lua")
...
//Script.Load("lua/ModularExo_Observatory.lua")
...
//Script.Load("lua/ModularExo_TechTreeButtons.lua")
...
//Script.Load("lua/ModularExo_GUIInsight_PlayerHealthbars.lua")
